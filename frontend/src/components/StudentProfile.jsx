...
function StudentProfile({ student, onBack }) {
    ...
    return (
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "20px", fontFamily: "sans-serif" }}>
                    ...
                    <div style={{ marginTop: "10px" }}>
                        ...
                        {isEditing ? (
                            <textarea
                                ...
                                placeholder="Medical notes, talents, special observations..."
                                style={{ ...inputStyle, height: "70px", resize: "vertical", display: "block", marginTop: "5px" }}
                            />
                        ) : (
                            editData.remarks
                                ? <p style={{ margin: "5px 0 0", padding: "8px", backgroundColor: "#fffbeb", border: "1px solid #fde68a", borderRadius: "5px", fontSize: "14px", color: "#374151" }}>{editData.remarks}</p>
                                : <p style={{ margin: "5px 0 0", color: "#9ca3af", fontSize: "13px", fontStyle: "italic" }}>None</p>
                        )}
                    </div>
            ...
            <div className="print-footer">Tezaura Universal</div>
